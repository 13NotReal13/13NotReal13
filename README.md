...
2. **[DestinyMatrix](https://github.com/13NotReal13/DestinyMatrix)**  
   Приложение для расчёта различных матриц судьбы (нумерология).  
   **Технологии**: Swift, SwiftUI, StoreKit, Firebase, AVFoundation (аудиостриминг), UserDefaults, кастомная бизнес-логика.
